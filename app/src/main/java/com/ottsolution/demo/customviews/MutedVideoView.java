...
public class MutedVideoView extends SurfaceView
    ...
    private int mAudioFocusType = AudioManager.AUDIOFOCUS_NONE; // legacy focus gain
    ...
    public CharSequence getAccessibilityClassName() {
        return MutedVideoView.class.getName();
    }
    ...
    private void openVideo() {
        ...
        try {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP && mAudioAttributes != null)
